...
<head>
    ...
    <title>Tawba - Islamic Center HTML Template - Shop Details</title>
            ...
            <div class="row gx-60">
                ...
                <div class="col-lg-6 align-self-center">
                    <div class="product-about">
                        ...
                        <h2 class="product-title">Muslim Men Prayer Hats</h2>
                        <div class="product-rating">
                            <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">1</span> customer rating</span></div>
                            <a href="shop-details.php" class="woocommerce-review-link">(<span class="count">3</span> customer reviews)</a>
                        </div>
                        <p class="text">Muslim men’s prayer hats, also known as taqiyah, kufi, or topi, are traditional head coverings worn during prayer and daily activities. These hats hold cultural and religious significance, symbolizing modesty and devotion.</p>
                        <div class="checklist">
                            <ul>
                                <li>Kufi – A short, rounded cap, commonly worn in African, Middle Eastern, and South Asian communities.</li>
                                <li>Taqiyah – A lightweight, often crocheted or embroidered cap, popular in Arab and South Asian regions.</li>
                                <li>Indonesian Peci (Songkok) – A black, velvet-like cap with a slightly pointed top, popular in Southeast Asia.</li>
                            </ul>
                        </div>
                        <div class="actions">
                            <div class="quantity">
                        ...
                        <div class="product_meta">
                            <span class="sku_wrapper">SKU: <span class="sku">cotton, wool, polyester </span></span>
                            <span class="posted_in">Category: <a href="shop.php" rel="tag">Islamic Clothing ,
                                    Headwear</a></span>
                            <span>Tags: <a href="shop.php">KufiCap</a><a href="shop.php">PrayerCap</a></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="product-details overflow-hidden space-top space-extra-bottom">
        <div class="container">
            <div class="row gx-60">
                ...
                <div class="col-lg-6 align-self-center">
                    <div class="product-about">
                        <p class="price">$80.85<del>$100.99</del></p>
                        <h2 class="product-title">Muslim Men Prayer Hats</h2>
                        <div class="product-rating">
                            <div class="star-rating" role="img" aria-label="Rated 5.00 out of 5"><span style="width:100%">Rated <strong class="rating">5.00</strong> out of 5 based on <span class="rating">1</span> customer rating</span></div>
                            <a href="shop-details.php" class="woocommerce-review-link">(<span class="count">3</span>
                                customer reviews)</a>
                        </div>
                        <p class="text">Muslim men’s prayer hats, also known as taqiyah, kufi, or topi, are traditional head
                            coverings worn during prayer and daily activities. These hats hold cultural and religious
                            significance, symbolizing modesty and devotion.</p>
                        <div class="checklist">
                            <ul>
                                <li>Kufi – A short, rounded cap, commonly worn in African, Middle Eastern, and South Asian
                                    communities.</li>
                                <li>Taqiyah – A lightweight, often crocheted or embroidered cap, popular in Arab and South
                                    Asian regions.</li>
                                <li>Indonesian Peci (Songkok) – A black, velvet-like cap with a slightly pointed top,
                                    popular in Southeast Asia.</li>
                            </ul>
                        </div>
                        <div class="actions">
                            <div class="quantity">
            ...
            <div class="tab-content" id="productTabContent">
                <div class="tab-pane fade" id="description" role="tabpanel" aria-labelledby="description-tab">
                    <p>The Quran is the central religious text of Islam, regarded by Muslims as the literal word of God
                        (Allah), revealed to the Prophet Muhammad (peace be upon him) over a period of 23 years (610–632
                        CE). It is written in classical Arabic and is considered the ultimate source of guidance for Muslims
                        in all aspects of life.

                        Structure of the Quran
                        114 chapters (Surahs), divided into verses (Ayahs).
                        Surahs are classified as Meccan (revealed in Mecca) or Medinan (revealed in Medina).
                        The longest chapter is Surah Al-Baqarah (Chapter 2), and the shortest is Surah Al-Kawthar (Chapter
                        108).
                        Themes of the Quran
                        The Quran addresses various topics, including:

                        Tawheed (Oneness of God) – The fundamental concept of monotheism.
                        Prophethood – Stories of past prophets like Adam, Noah, Abraham, Moses, and Jesus (peace be upon
                        them all).
                        Guidance for Humanity – Instructions on morality, justice, worship, and social conduct.
                        Afterlife – Descriptions of Paradise (Jannah) and Hell (Jahannam).
                        Laws and Ethics – Rules regarding personal, social, and economic life.
                        Preservation and Recitation
                        The Quran has remained unchanged since its revelation, preserved through memorization (Hifz) and
                        manuscripts.
                        It is recited in a melodic manner following specific rules (Tajweed).
                        Many Muslims strive to memorize the entire Quran, known as becoming a Hafiz.</p>
                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Muslim Men Prayer Hats</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Muslim Prayer Rug with Tasbih</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Digital Tasbih Counter</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Modefa Islamic Turkish Table</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Quran Tasbeeh</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Swiss Arabian Jamila</a></h3>
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Natural Miswak Toothbrush</a></h3>
                                    <span class="price">$320.85</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="swiper-slide">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">Prayer Rug and Prayer Beads</a></h3>
                                    <span class="price">$300.85</span>
                                </div>
                            </div>
                        </div>
