...
<head>
    ...
    <title>Tawba - Islamic Center HTML Template - Blog Grid View</title>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/bg/breadcumb-bg.jpg">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Blog Grid View</h1>
            ...
            <div class="row">
                <div class="col-lg-6 col-xl-4">
                    <div class="th-blog blog-single has-post-thumbnail single-grid">
                        <div class="blog-img">
                            <a href="blog-details.php"><img src="assets/img/blog/blog-grid-1.jpg" alt="Blog Image"></a>
                        </div>
                        <div class="blog-content">
                            <h2 class="box-title"><a href="blog-details.php">Faith and Resilience Challenges
                                    Through Islam</a>
                            </h2>
                            <div class="blog-meta">
                            ...
                            <p class="blog-text">Morbi semper, dui sodales aliquet imperdiet, lacus ligula congue neque, quis pretium lectus libero id.lacinia id proin auctor vulputate litora.</p>
                            <a href="contact.php" class="th-btn style2"><span class="btn-text" data-back="READ MORE" data-front="READ MORE"></span> </a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-xl-4">
                    <div class="th-blog blog-single has-post-thumbnail single-grid">
                        <div class="blog-img">
                            <a href="blog-details.php"><img src="assets/img/blog/blog-grid-2.jpg" alt="Blog Image"></a>
                        </div>
                        <div class="blog-content">
                            <h2 class="box-title"><a href="blog-details.php">unlocking the Wisdom of A Transformative Journey </a>
                            </h2>
                            <div class="blog-meta">
                                <a class="author" href="blog.php"><i class="fa-solid fa-user"></i>by David Smith</a>
                                <a href="blog.php"><i class="fa-sharp fa-solid fa-clock"></i>February 22,
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="th-blog blog-single has-post-thumbnail single-grid">
                        <div class="blog-img">
                            <a href="blog-details.php"><img src="assets/img/blog/blog-grid-3.jpg" alt="Blog Image"></a>
                        </div>
                        <div class="blog-content">
                            <h2 class="box-title"><a href="blog-details.php">Living sustainability A day in the life at
                                    rotal residence</a>
                            </h2>
                            <div class="blog-meta">
                                <a class="author" href="blog.php"><i class="fa-solid fa-user"></i>by David Smith</a>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="th-blog blog-single has-post-thumbnail single-grid">
                        <div class="blog-img">
                            <a href="blog-details.php"><img src="assets/img/blog/blog-grid-4.jpg" alt="Blog Image"></a>
                        </div>
                        <div class="blog-content">
                            <h2 class="box-title"><a href="blog-details.php">The workplace tells and screams for more top
                                    story.</a>
                            </h2>
                            <div class="blog-meta">
                                <a class="author" href="blog.php"><i class="fa-solid fa-user"></i>by David Smith</a>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="th-blog blog-single has-post-thumbnail single-grid">
                        <div class="blog-img">
                            <a href="blog-details.php"><img src="assets/img/blog/blog-grid-5.jpg" alt="Blog Image"></a>
                        </div>
                        <div class="blog-content">
                            <h2 class="box-title"><a href="blog-details.php">A Slice of Paradise Explore Our Resort
                                    Amenities</a>
                            </h2>
                            <div class="blog-meta">
                                <a class="author" href="blog.php"><i class="fa-solid fa-user"></i>by David Smith</a>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="th-blog blog-single has-post-thumbnail single-grid">
                        <div class="blog-img">
                            <a href="blog-details.php"><img src="assets/img/blog/blog-grid-6.jpg" alt="Blog Image"></a>
                        </div>
                        <div class="blog-content">
                            <h2 class="box-title"><a href="blog-details.php">What trends do we to start growing in
                                    the coming future?</a>
                            </h2>
                            <div class="blog-meta">
                                <a class="author" href="blog.php"><i class="fa-solid fa-user"></i>by David Smith</a>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="th-blog blog-single has-post-thumbnail single-grid">
                        <div class="blog-img">
                            <a href="blog-details.php"><img src="assets/img/blog/blog-grid-7.jpg" alt="Blog Image"></a>
                        </div>
                        <div class="blog-content">
                            <h2 class="box-title"><a href="blog-details.php">Handpicked Hotels and Resorts for Traveler’s Dream</a>
                            </h2>
                            <div class="blog-meta">
                                <a class="author" href="blog.php"><i class="fa-solid fa-user"></i>by David Smith</a>
                                <a href="blog.php"><i class="fa-sharp fa-solid fa-clock"></i>February 22,
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="th-blog blog-single has-post-thumbnail single-grid">
                        <div class="blog-img">
                            <a href="blog-details.php"><img src="assets/img/blog/blog-grid-8.jpg" alt="Blog Image"></a>
                        </div>
                        <div class="blog-content">
                            <h2 class="box-title"><a href="blog-details.php">Eco-Friendly Hotel Rooms at Our Nature-Inspired Resort</a>
                            </h2>
                            <div class="blog-meta">
                                <a class="author" href="blog.php"><i class="fa-solid fa-user"></i>by David Smith</a>
                                <a href="blog.php"><i class="fa-sharp fa-solid fa-clock"></i>February 22,
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="th-blog blog-single has-post-thumbnail single-grid">
                        <div class="blog-img">
                            <a href="blog-details.php"><img src="assets/img/blog/blog-grid-9.jpg" alt="Blog Image"></a>
                        </div>
                        <div class="blog-content">
                            <h2 class="box-title"><a href="blog-details.php">Discover and book a wide range of hotels
                                    rooms</a>
                            </h2>
                            <div class="blog-meta">
                                <a class="author" href="blog.php"><i class="fa-solid fa-user"></i>by David Smith</a>
