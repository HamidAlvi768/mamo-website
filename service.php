...
<head>
    ...
    <title>Tawba - Islamic Center HTML Template - All Services</title>
...
==============================-->
    <section class="overflow-hidden space-top overflow-hidden">
        <div class="container">
            <div class="row gy-4 justify-content-between load-more-active align-items-center">
                    ...
                    <div class="service-box2">
                        ...
                        <div class="box-content">
                            ...
                            <div class="service-btn">
                                <a href="service.php" class="simple-btn">Read More <i class="fa-regular fa-arrow-right ms-2"></i> </a>
                            </div>
                        </div>
                ...
                <div class=" col-md-6 col-xl-4">
                    <div class="service-box2">
                        ...
                        <div class="box-info">
                            ...
                            <h3 class="box-title"><a href="service-details.php">Community services</a></h3>
                        </div>
                        <div class="box-content">
                            <div class="box-wrapp">
                                <div class="box-icon">
                ...
                <div class=" col-md-6 col-xl-4">
                    <div class="service-box2">
                        ...
                        <div class="box-info">
                            ...
                            <h3 class="box-title"><a href="service-details.php">funneral services</a></h3>
                        </div>
                        <div class="box-content">
                            <div class="box-wrapp">
                                <div class="box-icon">
                ...
                <div class=" col-md-6 col-xl-4">
                    <div class="service-box2">
                        ...
                        <div class="box-info">
                            ...
                            <h3 class="box-title"><a href="service-details.php">health checkup</a></h3>
                        </div>
                        <div class="box-content">
                            <div class="box-wrapp">
                                <div class="box-icon">
                ...
                <div class=" col-md-6 col-xl-4">
                    <div class="service-box2">
                        <div class="box-img">
                            <img src="assets/img/service/service_1_7.jpg" alt="Icon">
                        </div>
                        <div class="box-info">
                            <div class="box-icon">
                        ...
                        <div class="box-content">
                            <div class="box-wrapp">
                                ...
                                <h3 class="box-title"><a href="service-details.php">Arabick Calligraphy Course</a></h3>
                                <p class="box-text">Master the art of Arabic calligraphy with our specialized course designed for beginners and advanced learners. </p>
                            </div>
                            <div class="service-btn">
                                <a href="service.php" class="simple-btn">Read More <i class="fa-regular fa-arrow-right ms-2"></i> </a>
                            </div>
                ...
                <div class=" col-md-6 col-xl-4">
                    <div class="service-box2">
                        <div class="box-img">
                            <img src="assets/img/service/service_1_8.jpg" alt="Icon">
                        </div>
                        <div class="box-info">
                            <div class="box-icon">
                        ...
                        <div class="box-content">
                            <div class="box-wrapp">
                                ...
                                <h3 class="box-title"><a href="service-details.php">Volunteering Services</a></h3>
                                <p class="box-text">we believe in the power of giving back. Our Volunteering Services provide opportunities to create a positive impact</p>
                            </div>
                            <div class="service-btn">
                                <a href="service.php" class="simple-btn">Read More <i class="fa-regular fa-arrow-right ms-2"></i> </a>
                            </div>
                ...
                <div class=" col-md-6 col-xl-4">
                    <div class="service-box2">
                        <div class="box-img">
                            <img src="assets/img/service/service_1_9.jpg" alt="Icon">
                        </div>
                        <div class="box-info">
                            <div class="box-icon">
                        ...
                        <div class="box-content">
                            <div class="box-wrapp">
                                ...
                                <h3 class="box-title"><a href="service-details.php">Fasting Services</a></h3>
                                <p class="box-text">provides Fasting Services to support individuals during Ramadan, voluntary fasts, and health-based fasting.</p>
                            </div>
                            <div class="service-btn">
                                <a href="service.php" class="simple-btn">Read More <i class="fa-regular fa-arrow-right ms-2"></i> </a>
                            </div>
                ...
                <div class=" col-md-6 col-xl-4 load-more d-none">
                    <div class="service-box2">
                        <div class="box-img">
                            <img src="assets/img/service/service_1_1.jpg" alt="Icon">
                        </div>
...
Faq Area
==============================-->
    <div class="overflow-hidden space-extra" id="faq-sec">
        <div class="container">
            <div class="row">
                <div class="col-xl-5">
