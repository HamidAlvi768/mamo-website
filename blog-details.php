...
<head>
    ...
    <title>Tawba - Islamic Center HTML Template - Blog Details</title>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/bg/breadcumb-bg.jpg" style="background-image: url('assets/img/bg/breadcumb-bg.jpg');">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Faith and Resilience Overcoming Challenges Through Islam</h1>
                ...
                <div class="col-xxl-9 col-lg-8">
                    <div class="th-blog blog-single">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a class="author" href="blog.php"><i class="fa-solid fa-user"></i>by David Smith</a>
                                <a href="blog.php"><i class="fa-sharp fa-solid fa-clock"></i>February 22,
                                    2025</a>
                                <a href="blog.php"><img src="assets/img/icon/light2.svg" alt="">Skill</a>
                            </div>
                            <p>On the Questo mobile app, gamified tours in the cities of Belogradchik, Vidin, and Vratsa now
                                ...
                                fully.</p>
                            <p class="mb-55">At SGW, we’ve been involved in several exciting projects that have enabled us
                                to apply
                                insights you gained from diverse industries to the development of solar modules. Our team
                                has successfully undertaken the design and development of various solar-powered products,
                                ranging from small-scale, solar-powered electronics to larger infrastructure and industrial
                                solutions. These projects have us plenty of interesting engineering challenges.</p>

                            <h2 class="box-title">Approch</h2>
                            <p>On the Questo mobile app, gamified tours in the cities of Belogradchik, Vidin, and Vratsa now
                                take you on a trip to reveal pieces of design and development of solar modules of rich
                                various solar-powered history that just need a little bit of unraveling to be appreciated
                                fully.</p>
                            ...
                            <p>The digital landscape is constantly evolving, and On Consult is here to keep you up to date
                                with the latest online marketing trends. Our expert team will guide you through the
                                intricacies of SEO, social media, content marketing, and more. With our help, you can
                                supercharge your online marketing skills and transform businesses.</p>
                            <div class="row mt-30">
                            ...
                            <p class="mb-30">On the Questo mobile app, gamified tours in the cities of Belogradchik, Vidin,
                                and Vratsa now take you on a trip to reveal pieces of design and development of solar
                                modules of rich various solar-powered history that just need a little bit of unraveling to
                                be appreciated fully.</p>
                            <p>At SGW, we’ve been involved in several exciting projects that have enabled us to apply
                                insights you gained from diverse industries to the development of solar modules. Our team
                                has successfully undertaken the design and development of various solar-powered products,
                                ranging from small-scale, solar-powered electronics to larger infrastructure and industrial
                                solutions. These projects have us plenty of interesting engineering challenges.</p>
                            ...
                            <div class="share-links clearfix ">
                                <div class="row justify-content-between">
                                    <div class="col-sm-auto">
                                        ...
                                        <div class="tagcloud">
                                            <a href="blog.php">Poor Child</a>
                                            <a href="blog.php">Fund</a>
                    ...
                    <div class="th-comments-wrap ">
                        <h2 class="blog-inner-title h5 fw-semibold">Comments (3)</h2>
                            ...
                            <li class="th-comment-item">
                                <div class="th-post-comment">
                                    ...
                                    <div class="comment-content">
                                        <h3 class="name">Amina Islam</h3>
                                        <span class="commented-on">25 Feb, 2025 08:56pm</span>
                    ...
                    <div class="th-comment-form ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 form-group mb-0">
                                <button class="th-btn text-uppercase"><span class="btn-text" data-back="Send Message" data-front="Send Message"></span></button>
                            </div>
                        </div>
                    </div>
                </div>
