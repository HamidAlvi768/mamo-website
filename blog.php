...
<head>
    ...
    <title>Tawba - Islamic Center HTML Template - Our Blog</title>
                ...
                <div class="col-xxl-9 col-lg-8">
                    <div class="th-blog blog-single has-post-thumbnail">
                        ...
                        <div class="blog-content">
                            <div class="blog-meta">
                                <a href="blog.php"><i class="fa-solid fa-calendar-days"></i>February 22,
                                    2025</a>
                                <a class="author" href="blog.php"><i class="fa-solid fa-user"></i>by David Smith</a>

                            </div>
                            <h3 class="blog-title"><a href="blog-details.php">On an island in the sun, coal power is king
                                    over abundant</a>
                            </h3>
                            <p class="blog-text">On the Questo mobile app, gamified tours in the cities of Belogradchik, Vidin, and Vratsa now
                    ...
                    <div class="th-blog blog-single has-post-thumbnail">
                        <div class="blog-img th-slider" data-slider-options='{"effect":"fade"}'>
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <a href="blog-details.php"><img src="assets/img/blog/blog-s-1-4.jpg" alt="Blog Image"></a>
                                </div>
                            </div>
                        ...
                        <div class="blog-content">
                            <h3 class="blog-title"><a href="blog-details.php">Unlocking the Wisdom of the Quran Journey</a>
                            </h3>
                            <div class="blog-meta">
                            ...
                            <p class="blog-text">The Quran is often described as a light and guidance for those seeking truth. It contains lessons on morality, justice, patience, gratitude, and compassion. Each verse carries layers of meaning that can be unlocked through sincere study and contemplation.</p>
                            <a href="blog-details.php" class="th-btn"><span class="btn-text" data-back="Read More" data-front="Read More"></span></a>
                        </div>
                    </div>
                    <div class="th-blog blog-single has-post-thumbnail">
                        <div class="blog-content">
                            ...
                            <h3 class="blog-title"><a href="blog-details.php">The Beauty of Salah Connecting with Allah in Every Moment</a>
                            </h3>
                            <div class="blog-meta">
                                <a href="blog.php"><i class="fa-solid fa-calendar-days"></i>February 25,
                                    2025</a>
                            ...
                            <p class="blog-text">Salah (prayer) is the most intimate act of worship in Islam, allowing believers to connect with Allah five times a day. It is more than a ritual; it is a spiritual journey that brings tranquility, discipline, and closeness to the Creator. Through Salah, a Muslim finds guidance, inner peace, and a constant reminder of life’s purpose.</p>
                            <a href="blog-details.php" class="th-btn"><span class="btn-text" data-back="Read More" data-front="Read More"></span> </a>
                        </div>
                    </div>
                    <div class="th-blog blog-single has-post-thumbnail">
                        <div class="blog-img" data-overlay="bg-title" data-opacity="5">
                            ...
                            <a href="https://www.youtube.com/watch?v=eIrRj6vDddU" class="play-btn popup-video"><i class="fas fa-play"></i></a>
                        </div>
                        <div class="blog-content">

                            <h3 class="blog-title"><a href="blog-details.php">Empowering Women Embracing Diversity in Tech</a>
                            </h3>
                            <div class="blog-meta">
                                <a href="blog.php"><i class="fa-solid fa-calendar-days"></i>February 25,
                                    2025</a>
                            ...
                            <p class="blog-text">Women bring unique perspectives, creativity, and problem-solving skills that enhance technological advancements. Diverse teams lead to better products, improved user experiences, and greater innovation.</p>
                            <a href="blog-details.php" class="th-btn"><span class="btn-text" data-back="Read More" data-front="Read More"></span> </a>
                        </div>
                    </div>
                    ...
                    <div class="th-pagination text-center">
                        <ul>
                            <li><a href="blog.php"><i class="fa-regular fa-arrow-left"></i></a></li>
                            <li><a href="blog.php">2</a></li>
                            <li><a href="blog.php">3</a></li>
                            <li><a href="blog.php">3</a></li>
                            <li><a href="blog.php">Next <i class="fa-regular fa-arrow-right"></i></a></li>
                        </ul>
                    </div>
                </div>
