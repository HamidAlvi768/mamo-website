...
<head>
    ...
    <title>Tawba - Islamic Center HTML Template - Tajweed rules & tafseer</title>
                    ...
                    <div class="page-single">
                        ...
                        <div class="page-content">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-sm-auto">
                                    <div class="page-img mb-0 global-img">
                                        <img class="w-100" src="assets/img/service/service_inner_2.jpg" alt="service">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xxl-3 col-lg-4">
                    <aside class="sidebar-area">
                        ...
                        <div class="widget widget_categories style2  ">
                            ...
                            <ul>
                                <li>
                                    <a href="service.php">Ramadan</a>
                                </li>
                                <li>
                                    <a href="service.php">hijri calendar</a>
                                </li>
                                <li>
                                    <a href="service.php">calligraphy</a>
                                </li>
                                <li>
                                    <a href="service.php">online course</a>
                                </li>
                                <li>
                                    <a href="service.php">quranic studies</a>
                                </li>
                                <li>
                                    <a href="service.php">islamic madrasha</a>
                                </li>
                                <li>
                                    <a href="service.php">maktab</a>
                                </li>
                                <li>
                                    <a href="service.php">Today update news</a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="space-extra-top mb-30">
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-md-auto d-none d-md-block">
                        <div class="sec-btn">
                            <a href="service.php" class="th-btn style2"><span class="btn-text" data-back="View All Services" data-front="View All Services"></span> </a>
                        </div>
                    </div>
                </div>
