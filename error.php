...
<head>
    ...
    <title>Tawba - Islamic Center HTML Template - Error page</title>
    ...
    <section class="error-area">
        <div class="container">
            <div class="error-content">
                ...
                <p class="error-text text-title mb-40">Oops! The page you’re looking for doesn’t exist</p>
                <a href="home-al-noor-haven.php" class="th-btn th-black"><i class="fal fa-home me-2"></i>Back To Home</a>
            </div>
        </div>
    </section><!--==============================
	Footer Area
