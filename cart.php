...
<head>
    ...
    <title>Tawba - Islamic Center HTML Template - Cart</title>
                    ...
                    <tbody>
                        <tr class="cart_item">
                            <td data-title="Product">
                                <a class="cart-productimage" href="shop-details.php"><img width="91" height="91" src="assets/img/product/product_1_1.png" alt="Image"></a>
                            </td>
                            <td data-title="Name">
                                <a class="cart-productname" href="shop-details.php">Muslim Men Prayer Hats</a>
                            </td>
                            <td data-title="Price">
                        ...
                        <tr class="cart_item">
                            <td data-title="Product">
                                <a class="cart-productimage" href="shop-details.php"><img width="91" height="91" src="assets/img/product/product_1_2.png" alt="Image"></a>
                            </td>
                            <td data-title="Name">
                                <a class="cart-productname" href="shop-details.php">Muslim Prayer Rug with Tasbih</a>
                            </td>
                            <td data-title="Price">
                                <span class="amount"><bdi><span>$</span>18</bdi></span>
                            </td>
                        ...
                        <tr class="cart_item">
                            <td data-title="Product">
                                <a class="cart-productimage" href="shop-details.php"><img width="91" height="91" src="assets/img/product/product_1_3.png" alt="Image"></a>
                            </td>
                            <td data-title="Name">
                                <a class="cart-productname" href="shop-details.php">Digital Tasbih Counter</a>
                            </td>
                            <td data-title="Price">
                                <span class="amount"><bdi><span>$</span>18</bdi></span>
                            </td>
