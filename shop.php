...
<head>
    ...
    <title>Tawba - Islamic Center HTML Template - Shops</title>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/bg/breadcumb-bg.jpg">
        <div class="container">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Islamic Shop</h1>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-9 col-lg-8">
                    <div class="th-sort-bar mt-0 mb-30">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="th-product product-grid">
                                ...
                                <div class="product-content">
                                    ...
                                    <h3 class="product-title"><a href="shop-details.php">The Clear Quran</a></h3>
                                    <span class="price">$320.85</span>
                                </div>
                            </div>
                        </div>
